...
In addition to the two classes used to manage TrackPy functions and output, the module TPHelper includes a serie of functions to analyse the trajectory collected.
